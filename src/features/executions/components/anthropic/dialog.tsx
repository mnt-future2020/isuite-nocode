  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent fullScreen>
        <VisuallyHidden.Root>
          <DialogTitle>Anthropic Claude Configuration</DialogTitle>
          <DialogDescription>
            Configure settings for the Anthropic Claude node.
          </DialogDescription>
        </VisuallyHidden.Root>
        <NodeEditorWorkspace
          title="Anthropic Claude"
          description="Build powerful AI applications with Anthropic's Claude models."
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription className="text-xs">
                      Context provided to the AI to guide its behavior.
                    </FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription className="text-xs">
                      The instruction or prompt to be processed.
                    </FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
